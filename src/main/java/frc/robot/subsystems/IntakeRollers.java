...
public class IntakeRollers extends SubsystemBase {
  ...
  // private final PWMSparkMax Low_v_Intake = new PWMSparkMax(Constants.LEFT_LOW_V_ROLLER_ID);
  // private final PWMSparkMax H_Band = new PWMSparkMax(Constants.ROLLERS_H_ID);
  // private final PWMSparkMax High_v_Intake = new PWMSparkMax(Constants.RIGHT_HIGH_V_ROLLER_ID);
